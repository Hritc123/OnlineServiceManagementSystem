...
<li class="nav-item"><a href="feedbackstore.php" class="nav-link text-white bg-dark active" style="border-radius:10px;">
...
<div class="col-sm-9">
<p class="alert alert-dark bg-dark text-white text-center" style="font-size:18px;">
Users FeedBack</p>  
<?php
...
<!----------------------------Start PHP Code For Delete Feedback--------->
<?php
...
{
echo'<script>location.href="feedbackstore.php"</script>';
}
}
?>
<!----------------------------End PHP Code For Delete Feedback--------->
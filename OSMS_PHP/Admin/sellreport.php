...
<li class="nav-item"><a href="sellreport.php" class="nav-link text-white bg-dark active" style="border-radius:10px;">
...
<!-------------------------Start Second  Column----------------> 
<div class="col-sm-10">
<p class="alert alert-dark bg-dark text-white text-center" style="font-size:18px;">Sell Report</p>
...
if($sDate<$eDate)
{
$sql="SELECT *FROM product_tb WHERE pDate BETWEEN '".$sDate."' AND '".$eDate."'";
...
echo'<th>Product Cost-Price</th>';
echo'<th>Product Sell-Price</th>';
...
echo'<td><img src="images/'.$row['pImage'].'" style="height:100px; width:100px;"></td>';
echo'</tr>';
}
echo'</tbody>';
echo'</table>';  

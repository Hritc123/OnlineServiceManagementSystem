...
$sql="UPDATE userregistration_tb SET rName='".$rName."' WHERE rEmail='".$rEmail."'";
...
<li class="nav-item"><a href="profile.php" class="nav-link bg-dark text-white" style="border-radius:10px;">
...
<input type="text" class="form-control" value="<?php echo $rName; ?>" name="rName">   
</div>
